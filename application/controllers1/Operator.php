...
class Operator extends CI_Controller
{
    ...
    public function transfers()
    {
      if($this->input->post('add_transfer')=='transfer')
      {
        ...
        $insertdata=array('userid_1'=>$tr_username_1,'tbl_waterright_1'=>$tr_water_right_1,'duration'=>$tr_duration,
...
public function get_volumeallocation()
{
  ...
  print_r(json_encode($meters));
    ...
    public function usage()
    {
                  ...
                  if (empty($data)) {
                    if($charge_code==5)
                    {
                      ...
                      foreach ($data as $meter) {
                          ...
                          $reading = $meter_reading;          if($charge_code==5)
                                    {
            ...
            ->post('edit_meter_readings')) == "save")
        {
          ...
          if($editdata[0]['meter_reading']!=$meter_reading)
          {
            ...
            $update=array('meter_reading'=>$editdata[0]['meter_reading']+$remain,
    ...
    public function add_meter_connection()
    {
        if ($this
            ...
            ->post('userid') != "" && $this
            ->input
            ->post('meter_name') != "" && $this
            ->input
            ->post('channel_name') != "" && $this
            ->input
            ->post('water_right_number') != "" && $this
            ->input
            ->post('property') != "" && $this
    ...
    public function load_usage_history()
    {
        ...
        $details = $this
            ->user_model
            ->get_joins('tbl_meter_reading', $where, $join, $columns, '', '', 'tbl_meter_reading.id DESC');
  ...
  array(
        ...
        $data['notifications'] = $this->user_model->get_joins('tbl_notifications','',$join,$column, '', '', 'tbl_notifications.id DESC');
    ...
    public function orders()
    {
        if($this->input->post('approved'))
        {
            ...
            ->session
            ->userdata('user_id');
              $update_data=array('operatorid'=>$operatorid,
              'isActive'=>1);
              ...
              if($update)
              {
                ...
                $update_data=array('senderid'=>$userid,
    ...
    public function graph_orders($status)
    {
      ...
      $data= array(array('start'=>'00:00','end'=>'01:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-00:00'.'-00:00'),'y'=>0)),
      array('start'=>'01:00','end'=>'02:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-01:00'),'y'=>0)),array('start'=>'02:00','end'=>'03:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-02:00'),'y'=>0))
     ,array('start'=>'03:00','end'=>'04:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-03:00'),'y'=>0)),array('start'=>'04:00','end'=>'05:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-04:00'),'y'=>0)),array('start'=>'05:00','end'=>'06:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-05:00'),'y'=>0)),array('start'=>'06:00','end'=>'07:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-06:00'),'y'=>0)),array('start'=>'07:00','end'=>'08:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-07:00'),'y'=>0))
     ,array('start'=>'08:00','end'=>'09:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-08:00'),'y'=>0)),array('start'=>'09:00','end'=>'10:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-09:00'),'y'=>0)),array('start'=>'10:00','end'=>'11:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-010:00'),'y'=>0)),array('start'=>'11:00','end'=>'12:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-11:00'),'y'=>0)),array('start'=>'12:00','end'=>'13:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-12:00'),'y'=>0)),array('start'=>'13:00','end'=>'14:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-13:00'),'y'=>0))
     ,array('start'=>'14:00','end'=>'15:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-14:00'),'y'=>0)),array('start'=>'15:00','end'=>'16:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-15:00'),'y'=>0)),array('start'=>'16:00','end'=>'17:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-16:00'),'y'=>0)),array('start'=>'17:00','end'=>'18:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-17:00'),'y'=>0)),array('start'=>'18:00','end'=>'19:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-18:00'),'y'=>0)),array('start'=>'19:00','end'=>'20:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-19:00'),'y'=>0))
     ,array('start'=>'20:00','end'=>'21:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-20:00'),'y'=>0)),array('start'=>'21:00','end'=>'22:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-21:00'),'y'=>0)),array('start'=>'22:00','end'=>'23:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-22:00'),'y'=>0)),array('start'=>'23:00','end'=>'00:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $current_date.'-23:00'),'y'=>0)));
     $datas= array(array('start'=>'00:00','end'=>'01:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-00:00'),'y'=>0)),
     array('start'=>'01:00','end'=>'02:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-01:00'),'y'=>0)),array('start'=>'02:00','end'=>'03:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-02:00'),'y'=>0))
    ,array('start'=>'03:00','end'=>'04:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-03:00'),'y'=>0)),array('start'=>'04:00','end'=>'05:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-04:00'),'y'=>0)),array('start'=>'05:00','end'=>'06:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-05:00'),'y'=>0)),array('start'=>'06:00','end'=>'07:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-06:00'),'y'=>0)),array('start'=>'07:00','end'=>'08:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-07:00'),'y'=>0))
    ,array('start'=>'08:00','end'=>'09:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-08:00'),'y'=>0)),array('start'=>'09:00','end'=>'10:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-09:00'),'y'=>0)),array('start'=>'10:00','end'=>'11:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-10:00'),'y'=>0)),array('start'=>'11:00','end'=>'12:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-11:00'),'y'=>0)),array('start'=>'12:00','end'=>'13:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-12:00'),'y'=>0)),array('start'=>'13:00','end'=>'14:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-13:00'),'y'=>0))
    ,array('start'=>'14:00','end'=>'15:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-14:00'),'y'=>0)),array('start'=>'15:00','end'=>'16:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-15:00'),'y'=>0)),array('start'=>'16:00','end'=>'17:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-16:00'),'y'=>0)),array('start'=>'17:00','end'=>'18:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-17:00'),'y'=>0)),array('start'=>'18:00','end'=>'19:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-18:00'),'y'=>0)),array('start'=>'19:00','end'=>'20:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-19:00'),'y'=>0))
    ,array('start'=>'20:00','end'=>'21:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-20:00'),'y'=>0)),array('start'=>'21:00','end'=>'22:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-21:00'),'y'=>0)),array('start'=>'22:00','end'=>'23:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-22:00'),'y'=>0)),array('start'=>'23:00','end'=>'00:00','flowRate'=>0,'graph'=>array('x'=>str_replace( array( '-', ':'), ',', $tommorow.'-23:00'),'y'=>0)));
...
// exit;
    ...
    public function load_allwater_orders()
    {
        ...
        if($order_usernames == 0){
        if ($channel_id == 0) {
            $where = ['tbl_water_orders.isActive !=' => 3];
        } else {
            $where = [
                'tbl_channels.id' => $channel_id,
        ...
        $orderExists = $this->user_model->get_joins(
            ...
            $where,
            $join,
            $columns, '', '', 'tbl_water_orders.id DESC'
        );
    ...
    public function load_new_water_orders()
    {
        ...
        $orderExists = $this->user_model->get_joins(
            ...
            $where,
            $join,
            $columns, '', '', 'tbl_water_orders.orderedDate DESC'
        );
        $current_date = date('Y-m-d');
        foreach ($orderExists as $orders) {
            $s = $orders['startTime'];
    ...
    public function update_message_count()
    {
     ...
     public function edit_water_orders()
     {
       ...
       $id=$this->input->post('id');
        ...
        $where=array('id'=>$id);
        $update=array('startTime'=>$start_time,
                       'flowRate'=>$flow_rate,
                     'duration'=>$duration,
                   'endTime'=>$end_time,
                 'totalVolume'=>$volume);
        ...
        if($is_update)
        {
          ...
          $insert=array('senderid'=>$senderid,
                        'senderrole'=>'operator',
                      'receiverid'=>$userid,
...
if(!empty($upcoming_orders))
{
  ...
  return $result;
       ...
       $end=date('Y-m-d', strtotime("+1 day", strtotime($start)));
           $data= array(array('start'=>'00:00','end'=>'01:00','flowRate'=>0,'orders'=>array()),
           array('start'=>'01:00','end'=>'02:00','flowRate'=>0,'orders'=>array()),array('start'=>'02:00','end'=>'03:00','flowRate'=>0,'orders'=>array())
          ,array('start'=>'03:00','end'=>'04:00','flowRate'=>0,'orders'=>array()),array('start'=>'04:00','end'=>'05:00','flowRate'=>0,'orders'=>array()),array('start'=>'05:00','end'=>'06:00','flowRate'=>0,'orders'=>array()),array('start'=>'06:00','end'=>'07:00','flowRate'=>0,'orders'=>array()),array('start'=>'07:00','end'=>'08:00','flowRate'=>0,'orders'=>array())
          ,array('start'=>'08:00','end'=>'09:00','flowRate'=>0,'orders'=>array()),array('start'=>'09:00','end'=>'10:00','flowRate'=>0,'orders'=>array()),array('start'=>'10:00','end'=>'11:00','flowRate'=>0,'orders'=>array()),array('start'=>'11:00','end'=>'12:00','flowRate'=>0,'orders'=>array()),array('start'=>'12:00','end'=>'13:00','flowRate'=>0,'orders'=>array()),array('start'=>'13:00','end'=>'14:00','flowRate'=>0,'orders'=>array())
          ,array('start'=>'14:00','end'=>'15:00','flowRate'=>0,'orders'=>array()),array('start'=>'15:00','end'=>'16:00','flowRate'=>0,'orders'=>array()),array('start'=>'16:00','end'=>'17:00','flowRate'=>0,'orders'=>array()),array('start'=>'17:00','end'=>'18:00','flowRate'=>0,'orders'=>array()),array('start'=>'18:00','end'=>'19:00','flowRate'=>0,'orders'=>array()),array('start'=>'19:00','end'=>'20:00','flowRate'=>0,'orders'=>array())
          ,array('start'=>'20:00','end'=>'21:00','flowRate'=>0,'orders'=>array()),array('start'=>'21:00','end'=>'22:00','flowRate'=>0,'orders'=>array()),array('start'=>'22:00','end'=>'23:00','flowRate'=>0,'orders'=>array()),array('start'=>'23:00','end'=>'00:00','flowRate'=>0,'orders'=>array()));
