...
class Service extends REST_Controller
{
  ...
  public function get_all_channels_get()
  {
    $column = array('id', 'username', 'email', 'contact', 'gender', 'address', 'image', 'channel', 'is_active');
    $operators = $this->user_model->get_joins('tbl_channels', '', '');
    if ($operators) {
      $this->response(array('status' => true, 'message' => 'All Channels', 'result' => $operators), 200);
    } else {
      $this->response(array('status' => false, 'message' => 'Channels not found', 'result' => 'Channels not found'), 200);
    }
  }
    ...
    if ($text != '') {
      ...
      if ($meterConnectionsExists) {
        ...
        foreach ($meterConnectionsExists as $meters) {
          ...
          $MQTTData = $this->get_live_data_MQTT($meters);
          ...
          if ($meters['isActive'] == 1) {
            $collect = array(
              ...
              'flow_rate' => $MQTTData['flowRate'], 
              'usage' => $MQTTData['usage'],
              'reading' => $MQTTData['reading'],
              'flow_rate_topic' => $meters['flow_rate_topic'],
              'telementry' => $meters['telementry'],
              'flow_rate_scaling' => $meters['flow_rate_scaling'],
              'flow_total_reading_topic' => $meters['flow_total_reading_topic'],
              'flow_total_reading_scaling' => $meters['flow_total_reading_scaling'],
      ...
      if ($meterConnectionsExists) {
        ...
        if (sizeof($connections) > 0) {
          $this->response(array('status' => true, 'message' => 'Meter Connections1', 'result' => $connections), 200);
        } else {
          $this->response(array('status' => true, 'message' => 'No Meter Connections', 'result' => []), 200);
        }
      } else {
  ...
  public function view_meter_readings_post()
  {
    ...
    if ($meter_id != '') {
      $site_url = base_url() . 'assets/meterimages/';
      $where = array('tbl_meter_reading.meter_id' => $meter_id);
  ...
  public function add_water_order_post()
  {
    ...
    //   'token' => 'cQkaLV7fTj2Bwj7GTsCDd5:APA91bFOs1nHEP0oKKTSZ0q4JLrEAUvlREWA5_4PZO8mZ9zqO-vNLqxtuv_POWTPwPHTmzsVJjJdR-4EBymZIJOLfLGQ2FkPm7w9-6v-VSesNtpdT9Us0u2sMu-dAhkYBxwqZNYvJ4g4',
    //   'type' => 101
    // );
      ...
      if (in_array($insert, $users_data)) {
        ...
        if ($insert) {
          ...
          $this->response(array(
            ...
            'result'=>$insert, 
            'operator_token' => $tokenExists, 
            'user_token' => $usertokenExists,
            'sent_notifications' => $ispushstatus
          ),200);
        } else {
          $this->response(array('status' => false, 'message' => 'Error creating Operator', 'result' => 'Error creating Operator'), 200);
        }
    ...
    if (($orderid != "") && ($meterid != "")) {
      ...
      if (empty($users_data)) {
        ...
        if ($is_update) {
          ...
          if ($tokenExists) {
            $notifiyOperator = array(
              'title' => 'Water Order Updated Successfully',
  ...
  public function usage_informationby_meter_post()
  {
    ...
    if ($userid != "") {
      ...
      foreach ($informationExists as $info) {
        ...
        $MQTTData = $this->get_live_data_MQTT($info);
        $data = array(
          'id' => $info['id'],
          ...
          'usage' => $MQTTData['usage'],
          'reading' => $MQTTData['reading'],
          'flow_rate_topic' => $info['flow_rate_topic'],
          'telementry' => $info['telementry'],
          'flow_rate_scaling' => $info['flow_rate_scaling'],
          'flow_total_reading_topic' => $info['flow_total_reading_topic'],
          'flow_total_reading_scaling' => $info['flow_total_reading_scaling'],
  ...
  public function checkTimeSlot($orders)
  {
    ...
    $data = array(
      array('start' => '00:00', 'end' => '01:00', 'flow_rate' => 0, 'orders' => array()),
      array('start' => '01:00', 'end' => '02:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '02:00', 'end' => '03:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '03:00', 'end' => '04:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '04:00', 'end' => '05:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '05:00', 'end' => '06:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '06:00', 'end' => '07:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '07:00', 'end' => '08:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '08:00', 'end' => '09:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '09:00', 'end' => '10:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '10:00', 'end' => '11:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '11:00', 'end' => '12:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '12:00', 'end' => '13:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '13:00', 'end' => '14:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '14:00', 'end' => '15:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '15:00', 'end' => '16:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '16:00', 'end' => '17:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '17:00', 'end' => '18:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '18:00', 'end' => '19:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '19:00', 'end' => '20:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '20:00', 'end' => '21:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '21:00', 'end' => '22:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '22:00', 'end' => '23:00', 'flow_rate' => 0, 'orders' => array()), array('start' => '23:00', 'end' => '00:00', 'flow_rate' => 0, 'orders' => array())
    );
  ...
  public function save_device_token_post()
  {
    ...
    $app_status = $this->input->post('app_status') ? $this->input->post('app_status') : "";
    $push_status = $this->input->post('push_status') ? $this->input->post('push_status') : "";
    ...
    if (($userid != "") && ($token != "")) {
      ...
      if ($tokenExists) {
        ...
        if($push_status != ""){
          $updatedata['push_status'] = $push_status;
        }
        $is_update = $this->user_model->UPDATEDATA('tbl_tokens', $condition, $updatedata);
        if ($is_update) {
  ...
  function cronPushNotification($message)
  {
    ...
    $firebase_api = "AAAAeunCsKs:APA91bFs5b9L2B81SQ3h_9WXCZtniZoZGCc3I20k8Et3MziUa7gH-9keUw1CDTdmBSTbUcR-XJDFUcb2tmzP0TPbAtElRk-xOReaQbsE41EYUvNQZM4DOqkCDSnt_uXdTfj_o3ltAZVl";
    $fields = '{
      "to":"' . $usertoken . '",
      "priority": "high",
      "notification": {
  ...
  public function graph_values_post()
  {
    ...
    $data = array(
      array('start' => '00:00', 'end' => '01:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 00:00'), 'y' => 0)),
      array('start' => '01:00', 'end' => '02:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 01:00'), 'y' => 0)), array('start' => '02:00', 'end' => '03:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 02:00'), 'y' => 0)), array('start' => '03:00', 'end' => '04:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 03:00'), 'y' => 0)), array('start' => '04:00', 'end' => '05:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 04:00'), 'y' => 0)), array('start' => '05:00', 'end' => '06:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 05:00'), 'y' => 0)), array('start' => '06:00', 'end' => '07:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 06:00'), 'y' => 0)), array('start' => '07:00', 'end' => '08:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 07:00'), 'y' => 0)), array('start' => '08:00', 'end' => '09:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 08:00'), 'y' => 0)), array('start' => '09:00', 'end' => '10:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 09:00'), 'y' => 0)), array('start' => '10:00', 'end' => '11:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 010:00'), 'y' => 0)), array('start' => '11:00', 'end' => '12:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 11:00'), 'y' => 0)), array('start' => '12:00', 'end' => '13:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 12:00'), 'y' => 0)), array('start' => '13:00', 'end' => '14:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 13:00'), 'y' => 0)), array('start' => '14:00', 'end' => '15:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 14:00'), 'y' => 0)), array('start' => '15:00', 'end' => '16:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 15:00'), 'y' => 0)), array('start' => '16:00', 'end' => '17:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 16:00'), 'y' => 0)), array('start' => '17:00', 'end' => '18:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 17:00'), 'y' => 0)), array('start' => '18:00', 'end' => '19:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 18:00'), 'y' => 0)), array('start' => '19:00', 'end' => '20:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 19:00'), 'y' => 0)), array('start' => '20:00', 'end' => '21:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 20:00'), 'y' => 0)), array('start' => '21:00', 'end' => '22:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 21:00'), 'y' => 0)), array('start' => '22:00', 'end' => '23:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 22:00'), 'y' => 0)), array('start' => '23:00', 'end' => '00:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($current_date . ' 23:00'), 'y' => 0))
    );
    $datas = array(
      array('start' => '00:00', 'end' => '01:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 00:00'), 'y' => 0)),
      array('start' => '01:00', 'end' => '02:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 01:00'), 'y' => 0)), array('start' => '02:00', 'end' => '03:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 02:00'), 'y' => 0)), array('start' => '03:00', 'end' => '04:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 03:00'), 'y' => 0)), array('start' => '04:00', 'end' => '05:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 04:00'), 'y' => 0)), array('start' => '05:00', 'end' => '06:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 05:00'), 'y' => 0)), array('start' => '06:00', 'end' => '07:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 06:00'), 'y' => 0)), array('start' => '07:00', 'end' => '08:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 07:00'), 'y' => 0)), array('start' => '08:00', 'end' => '09:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 08:00'), 'y' => 0)), array('start' => '09:00', 'end' => '10:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 09:00'), 'y' => 0)), array('start' => '10:00', 'end' => '11:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 10:00'), 'y' => 0)), array('start' => '11:00', 'end' => '12:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 11:00'), 'y' => 0)), array('start' => '12:00', 'end' => '13:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 12:00'), 'y' => 0)), array('start' => '13:00', 'end' => '14:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 13:00'), 'y' => 0)), array('start' => '14:00', 'end' => '15:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 14:00'), 'y' => 0)), array('start' => '15:00', 'end' => '16:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 15:00'), 'y' => 0)), array('start' => '16:00', 'end' => '17:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 16:00'), 'y' => 0)), array('start' => '17:00', 'end' => '18:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 17:00'), 'y' => 0)), array('start' => '18:00', 'end' => '19:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 18:00'), 'y' => 0)), array('start' => '19:00', 'end' => '20:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 19:00'), 'y' => 0)), array('start' => '20:00', 'end' => '21:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 20:00'), 'y' => 0)), array('start' => '21:00', 'end' => '22:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 21:00'), 'y' => 0)), array('start' => '22:00', 'end' => '23:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 22:00'), 'y' => 0)), array('start' => '23:00', 'end' => '00:00', 'flowRate' => 0, 'orders' => array(), 'graph' => array('x' => ($tommorow . ' 23:00'), 'y' => 0))
    );
