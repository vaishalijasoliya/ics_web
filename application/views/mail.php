                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" valign="top" class="textContent">
                                                                        <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Intelligent Canal Systems</h1>
                                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;margin-top:10px;">Enquiery recieved from Irrigator Portal</div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                  <table>
                                                                                    <tr>
                                                                                      <td><h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">From :</h3></td><td><?php echo $email; ?></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                      <td><h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Name :</h3></td><td><?php echo $name; ?></td>
                                                                                    </tr>
                                                                                      <tr>
                                                                                        <td><h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Subject :</h3></td><td><?php echo $subject; ?></td>
                                                                                      </tr>
                                                                                        <tr>
                                                                                          <td><h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Message</h3></td><td></td>
                                                                                        </tr>
                                                                                  </table>

                                                                                    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-top:20px;"><?php echo ucfirst($message); ?></div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // CONTENT TABLE -->
