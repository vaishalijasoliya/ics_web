<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Operators</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                  <li class="nav-item">
                    <a class="nav-link active" href="#"  data-toggle="modal"  data-target="#addnewoperator">  <i class="nav-icon fas fa-plus"></i>&nbspAdd Operator</a>
                  </li>
            ...
            <div class="card-body">
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm">
                      <a href="<?php echo base_url('Admin/viewoperator/'.$value['id']); ?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
                 ...
                 <div class="modal fade" id="updateoperator<?php echo $value['id']; ?>">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <form action="<?php echo base_url('Admin/viewoperators'); ?>" method="post">
                      ...
                      <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" name="updateoperator" value="save" >Save</button>
                      </div>
                      </form>
                    </div>
                    <!-- /.modal-content -->
              ...
              <div class="modal fade" id="addnewoperator">
               <div class="modal-dialog">
                 <div class="modal-content">
                   <div class="modal-header">
                   ...
                   <div class="modal-footer justify-content-between">
                     <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                     <button type="submit" class="btn btn-primary" name="addnewoperator" value="save" >Save</button>
                   </div>
                   </form>
                 </div>
                 <!-- /.modal-content -->
