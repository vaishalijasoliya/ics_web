      ...
      <div class="row">
         <div class="total-report">
            ...
            <div class="total-report-btn">
               ...
               <a href="<?= base_url('Operator/notification') ?>" class="usage-report">
                  Notification
               </a>

               <a href="<?= base_url('Operator/notification_archive') ?>" class="usage-report active_a" id="home-tab" style="margin-left:5px;">
            ...
            <div class="total-report-table">
               <!-- meters table start-->
               <div class="table-responsive text-nowrap active_b" id="home" role="tabpanel" aria-labelledby="profile-tab">
