                        ...
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                 ...
                                 <li><a class="dropdown-item" href="<?php echo base_url('Operator/live_flow'); ?>">Live Flow</a></li>

                              </ul>
                           </li>
                           <li class="nav-item"><a href="<?php echo base_url('Operator/orders'); ?>">Orders</a></li>
                           <li class="nav-item"><a href="<?php echo base_url('Operator/notification'); ?>">Notification<span class="badge">5</span></a></li>
