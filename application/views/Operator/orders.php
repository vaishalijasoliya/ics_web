...
<section class="water-usage">
	<div class="container">
		...
		<div class="row">
			<!-- row start-->
			<div class="water-usage-btn" style="margin-top:5%;" id="myTab" role="tablist">
				<!-- meters control btn start-->
				<a style="cursor: pointer;" class="usage-report active_a" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">
					Live Orders
				</a>
				<a class="usage-report" style="margin-left:5px; cursor: pointer;" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
					Archived
				</a>
			</div>
			<!-- meters control btn end-->
			<div class="usage-table" id="myTabContent">

				<!-- meters table start-->
				<div class="table-responsive text-nowrap" class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
				...
				<!-- meters table start-->
				<div class="table-responsive text-nowrap" id="profile" role="tabpanel" aria-labelledby="profile-tab">
					<table class="table" id="water_order_system_archive">
						<thead>
							<tr>
								<th scope="col">Name</th>
								<th scope="col">Start Time</th>
...
<script type="text/javascript">
	...
	$('#home-tab').click(function(e) {
		...
		$("#profile-tab").removeClass("active_a");
		$('#home').show();
		$('#profile').hide();
	});
	...
	$('#profile-tab').click(function(e) {
		e.preventDefault();
		$("#home-tab").removeClass("active_a");
		$("#home").removeClass("active_b");
		$("#profile-tab").addClass("active_a");
		$('#home').hide();
		$('#profile').show();
	});
</script>