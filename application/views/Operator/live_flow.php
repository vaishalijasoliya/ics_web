      ...
      <div class="row">
         ...
         <div class="client-deatils-form">
            ...
            <div class="row">
               ...
               <!-- <div class="col-sm-4 col-lg-4">
                  <div class="form-group">
                     <select class="form-control form-control-lg" data-style="btn-info" name="ud_clientdetail_username" id="lf_username">
               ...
               <div class="col-sm-4 col-lg-4">
                  <div class="form-group">
                        ...
                        <select class="form-control form-control-lg" data-style="btn-info" name="channel" id="channel">
         ...
         <div class="client-usage-table" style="margin-bottom:10px;">
            ...
            <div class="table-responsive text-nowrap">
               <table class="table" id="live_flow">
                  <thead>
                     <tr>
                        ...
                        <th scope="col">Live Flow Rate</th>
