        ...
        <div class="row">
          <div class="col-lg-6">
           ...
           <p style="padding-right:140px;">
            Please contact us to assist with any operator assistance, issues, troubleshooting or to suggest new features for our products. Our technical support team will respond within 24 hours. </p>
          ...
          <div class="col-lg-6">
            <div class="form">
              ...
              <form action="<?php echo base_url('operator/contact_mail'); ?>" method="post" role="form" class="contactForm" id="mailform">
