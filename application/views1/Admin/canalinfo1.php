...
<?php } ?>
  <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-md-4 my-2">
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addnewright"><i class="fas fa-plus"></i>&nbspAdd Water Right</button>
        </div>
        <div class="col-md-4 my-2">
    ...
    <!-- addnewright modal -->
    <div class="modal fade" id="addnewright">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="<?php echo base_url('Admin/canal_info'); ?>" method="post">
          <div class="modal-body">
            <div class="form-group">
              <input type="text" name="wr_number" class="form-control" placeholder="Enter Water Right" required>
            </div>
          </div>
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary" name="addnewright" value="save" >Save</button>
          </div>
          </form>
        </div>
        <!-- /.modal-content -->
        ...
        <div class="col-md-4">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Water Rights</h3>
              ...
              <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#updatenewright<?php echo $value['id']; ?>"><i class="fas fa-edit"></i></a>
                          <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#deletenewright<?php echo $value['id']; ?>"><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                    <!-- update modal -->
                    <div class="modal fade" id="updatenewright<?php echo $value['id']; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form action="<?php echo base_url('Admin/canal_info'); ?>" method="post">
                          <div class="modal-body">
                            ...
                            <input type="hidden" name="id" value="<?php echo $value['id']; ?>" >
                              <input type="text" name="wr_number" class="form-control" placeholder="Enter channel name" value="<?php echo $value['wr_number']; ?>" required>
                            </div>
                          </div>
                          <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-primary" name="updatenewright" value="save" >Save</button>
                          </div>
                          </form>
                        </div>
                        <!-- /.modal-content -->
                    ...
                    <!-- update modal ends-->
                     ...
                     <div class="modal fade" id="deletenewright<?php echo $value['id']; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form action="<?php echo base_url('Admin/canal_info'); ?>" method="post">
                            <div class="modal-body">
                              <p>Are you sure want to remove <strong><?php echo $value['wr_number']; ?></strong> ?</p>
                              <input type="hidden" name="id" value="<?php echo $value['id']; ?>" >
                            </div>
                            <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                            <button type="submit" class="btn btn-danger" name="deletenewright" value="save" >Yes</button>
                            </div>
                          </form>
                        </div>
                        <!-- /.modal-content -->
